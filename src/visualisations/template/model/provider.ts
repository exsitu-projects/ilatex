...
import { TemplateVisualisationModel } from "./model";


export class TemplateVisualisationModelProvider implements VisualisationModelProvider {
    ...
    ): TemplateVisualisationModel {
        return new TemplateVisualisationModel(
