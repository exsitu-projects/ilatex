...
export class ImageTransitionalView extends TransitionalView {
    private static readonly DELAY_BETWEEN_NON_FINAL_OPTIONS_UPDATES = 50; // ms
    static readonly transitionalName = "includegraphics";
    ...
    constructor(contentNode: HTMLElement, metadata: TransitionalMetadata, context: TransitionalViewContext) {
        ...
        this.nonFinalOptionsUpdateThrottler = new TaskThrottler(ImageTransitionalView.DELAY_BETWEEN_NON_FINAL_OPTIONS_UPDATES);
    }
    
    private get imageNode(): HTMLImageElement {
        return ImageTransitionalView.extractImageFrom(this.contentNode);
    }
    ...
    private get options(): IncludegraphicsOptions {
        return ImageTransitionalView.extractOptionsFrom(this.contentNode);
    }
    ...
    onBeforeTransitionalRemoval(): void {
        super.onAfterTransitionalRemoval();
