...
\begin{document}
    ...
    \begin{figure}[h]
        \centering
        \ilatex{\includegraphics[width=170px, trim=1px 56px 85px 0px, clip]{img/rabbit.jpg}}
    ...
    \begin{figure}
        ...
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \ilatex{\includegraphics[width=.4\linewidth]{img/cat.jpg}}
            \caption{Picture of a cat.}
            \label{fig:cat1}
        \end{subfigure}%
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \ilatex{\includegraphics[width=.4\linewidth]{img/cat-drawing.png}}
